...
soft='GLPI - swcpuram plugin'
email='eduardomozart182@gmail.com'
copyright='Net House Informática Development Team'

# Only strings with domain specified are extracted (use Xt args of keyword param to set number of args needed)

xgettext *.php */*.php --copyright-holder="COPYRIGHT" --package-name="$soft" -o locales/swcpuram.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
